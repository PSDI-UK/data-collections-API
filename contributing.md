...
for all contributions to `data_collections_api`. Also contained are instructions and tips for
...
``` sh
git clone git@github.com:PSDI-UK/data-collections-API.git
```
...
``` sh
git clone git@github.com:<username>/data-collections-API.git
```

or added as an alternative origin in the *upstream* cloned repository:

``` sh
git remote add personal git@github.com:<username>/data-collections-API.git
```
...
``` sh
$ git clone -b fix-xyz --single-branch git@github.com:<username>/data-collections-API.git
```
...
$ git clone git@github.com:<username>/data-collections-API.git my_dir
$ cd my_dir
...
you can also do this through the web UI.
